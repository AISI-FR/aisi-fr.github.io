...
Les groupes déployés sont, entre autre, [Brass Typhoon]( https://attack.mitre.org/groups/G0096/), [Mulberry Typhoon](https://attack.mitre.org/groups/G1023/) et [Violet Typhoon](https://attack.mitre.org/groups/G0128/).
...
Les groupes déployés sont, entre autre, [Remix Kitten](https://attack.mitre.org/groups/G0087/), [Static Kitten](https://attack.mitre.org/groups/G0069/) et [Charming Kitten](https://attack.mitre.org/groups/G0059/). 
...
Les groupes déployés sont, entre autre, [Labyrinth Chollima](https://attack.mitre.org/groups/G0032/), [Velvet Chollima](https://attack.mitre.org/groups/G0094/) et [Silent Chollima](https://attack.mitre.org/groups/G0138/).
...
Les groupes déployés sont, entre autre, [Venomous Bear](https://attack.mitre.org/groups/G0010/), [Cozy Bear](https://attack.mitre.org/groups/G0016/) et [Fancy Bear](https://attack.mitre.org/groups/G0007/).
...
1. cibler directement des entités financières (instituions financières, systèmes SWIFT, iIndustrie des cryptomonnaies)
...
Parmi ces groupes nous pouvons citer les rançongiciels-en-tant-que-service (rançongiciel proposé à la location) [Lockbit](https://attack.mitre.org/software/S1202/) et [Conti](https://attack.mitre.org/software/S0575/) mais aussi les rançongciels [Ryuk](https://attack.mitre.org/software/S0446/) et [REvil](https://attack.mitre.org/software/S0496/).
...
* Les institutions financières tels que les banques et les plateformes de cryptomonnaies etc (ex. : la Corée du Nord cible des plateformes d’échange de cryptomonnaies telles que [Bybit](https://www.nccgroup.com/research-blog/in-depth-technical-analysis-of-the-bybit-hack/)).
